...
<h4>Edit souvenir</h4>
<?php echo form_open_multipart('cadmin/edit_souvenir/'.$hasil->id_souvenir); ?>

<table>
<tr>
	<td class="td" width="40"> Nama Souvenir</td>
	<td class="td"> : </td>
	<td> <?php echo form_input('nama_souvenir',$hasil->nama_souvenir); ?> </td>
</tr>
<tr>
	<td class="td"> Harga</td>
	<td class="td"> : </td>
	<td> <?php echo form_input('harga',$hasil->harga); ?> </td>
</tr>
<tr>
	<td class="td"> Gambar Awal </td>
	<td class="td"> : </td>
	<td> <img src="<?=base_url();?>gambar/thumbnails/<?php echo $hasil->gambar;?>"/> </td>
</tr>
<tr>
