...
<body>
<?php echo form_open_multipart('cadmin/edit_isi_menu/'.$hasil->id_menu); ?>
<H2>Edit isi menu<?php echo " ".$hasil->judul_menu; ?> </h2>
<table>
<tr>
	<td class="td" width="40"> Nama Menu</td>
	<td class="td"> : </td>
	<td> <?php echo $hasil->judul_menu; ?> </td>
</tr>
<tr valign="top">
	<td class="td"> Isi </td>
	<td class="td"> : </td>
